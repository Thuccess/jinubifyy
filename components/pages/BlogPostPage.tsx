        ...
        <div className="bg-white dark:bg-slate-900 py-16 sm:py-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <AnimatedSection>
                    ...
                    <article className="prose prose-lg lg:prose-xl dark:prose-invert max-w-none mt-12 text-slate-600 dark:text-slate-400 prose-headings:font-extrabold prose-headings:text-slate-800 dark:prose-headings:text-slate-100" dangerouslySetInnerHTML={{ __html: post.content }}></article>
