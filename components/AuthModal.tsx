...
// FIX: Imported GoogleIcon and GitHubIcon from './icons/Socials' and XMarkIcon from './icons/Icons'.
import { XMarkIcon } from './icons/Icons';
import { GoogleIcon, GitHubIcon } from './icons/Socials';

// FIX: Defined AuthModalView and User types locally to make the component self-contained.
...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, initialView = 'signIn', onLoginSuccess }) => {
  ...
  const SocialButton = ({ icon, children, onClick, disabled }: { icon: React.ReactNode, children: React.ReactNode, onClick?: () => void, disabled?: boolean }) => (
      <button 
        type="button"
        onClick={onClick}
        disabled={disabled}
      ...
      >
        ...
        <div className="p-8">
            ...
            <div className="space-y-3 mb-6">
                {/* FIX: Added required 'children' prop to provide the button's text content. */}
                <SocialButton 
